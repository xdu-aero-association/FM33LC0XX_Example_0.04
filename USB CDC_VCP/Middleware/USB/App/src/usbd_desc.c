...
#define USBD_VID                        0x464D	//VID
#define USBD_PID                        0x0402	//PID

#define USBD_LANGID_STRING              0x0402
#define USBD_MANUFACTURER_STRING        "FMSH"
#define USBD_PRODUCT_HS_STRING          "FMSH Virtual ComPort in HS mode"
#define USBD_PRODUCT_FS_STRING          "FMSH Virtual ComPort in FS Mode"
