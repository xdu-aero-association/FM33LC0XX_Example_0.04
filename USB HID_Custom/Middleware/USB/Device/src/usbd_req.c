...
extern __IO USB_OTG_DCTL_TypeDef SET_TEST_MODE;
    ...
    #endif
#endif
__ALIGN_BEGIN uint32_t USBD_ep_status __ALIGN_END  = 0;//¶Ëµã×´Ì¬
    ...
    #endif
#endif
__ALIGN_BEGIN uint32_t  USBD_default_cfg __ALIGN_END  = 0;//Ä¬ÈÏÅäÖÃ
    ...
    #endif
#endif
__ALIGN_BEGIN uint32_t  USBD_cfg_status __ALIGN_END  = 0;//ÅäÖÃ×´Ì¬
